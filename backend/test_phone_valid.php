...
// Numéro qui existe déjà dans leur base (vu dans le search précédent)
$validPhone = '+213655648451';

echo "Testing existing valid phone: $validPhone\n";
$r = zrRequest('POST', 'https://api.zrexpress.app/api/v1/customers/individual', [
    'name'  => 'Test Valid Phone',
    'phone' => ['number1' => $validPhone],
    'addresses' => [
        [
            'city'                => 'Alger',
